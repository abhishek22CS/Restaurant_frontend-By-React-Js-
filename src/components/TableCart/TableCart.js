      ...
      return (
        <>
          ...
          <Grid item xs={3} style={{ display: "flex", justifyContent: "right" }}>
            <Plusminus  onChange={(v) => handleQtyChange(v, item)}   qty={item?.qty} />
          </Grid>
      ...
      <>
        ...
        <Grid item xs={6}>
          <Button
            onClick={handleSave}
            variant="contained"
            style={{ display: "flex", marginLeft: "auto", background: "green" }}
          >
            Save & Print
          </Button>
        </Grid>
    ...
    return (
      <div>
        <Grid container spacing={1} style={{ fontFamily: "kanit" }}>
          ...
          <Grid item xs={3} style={{ fontWeight: "bold", textAlign: "center" }}>
            Qty
          </Grid>
          <Grid item xs={2} style={{ fontWeight: "bold", textAlign: "right" }}>
            Amount
